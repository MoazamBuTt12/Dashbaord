...
import promo from "./media/various/landing-promo-hero.png"
import promo1 from "./media/various/preview-db-default.png"
import promo2 from "./media/various/preview-db-classic.png"
import promo3 from "./media/various/preview-db-social.png"
import promo4 from "./media/various/preview-db-clean.png"
import promo5 from "./media/various/preview-db-corporate.png"
import promo6 from "./media/various/preview-db-minimal.png"
import promo7 from "./media/various/preview-db-pop.png"
import promo8 from "./media/various/preview-db-medical.png"
import promo9 from "./media/various/preview-db-dashboard2.png"
import pack from "./media/various/preview-page-pack-crypto.png"
import pack1 from "./media/various/preview-page-pack-ecommerce.png"
import pack2 from "./media/various/preview-page-pack-elearning.png"
import pack3 from "./media/various/preview-page-pack-forum.png"
import pack4 from "./media/various/preview-page-pack-auth.png"
import pack5 from "./media/various/preview-page-pack-error.png"
import pack6 from "./media/various/landing-promo-layout-backend.png"
import pack7 from "./media/various/landing-promo-layout-classic-dashboard.png"
import pack8 from "./media/various/landing-promo-layout-api.png"
import land1 from "./media/various/landing-promo-bootstrap-grid.png"
import land2 from "./media/various/landing-promo-bootstrap-typography.png"
import land3 from "./media/various/landing-promo-bootstrap-buttons.png"
import land4 from "./media/various/landing-promo-smart-tools.png"
import land5 from "./media/various/landing-promo-developer-minded-php.png"
import land6 from "./media/various/landing-promo-developer-minded-docs.png"
import land7 from "./media/various/landing-promo-developer-minded-html.png"
...
<main id="main-container">
      ...
      <div class="content content-full">
        <div class="row g-6 w-100 py-7 overflow-hidden">
          <div class="col-md-7 order-md-last py-4 d-md-flex align-items-md-center justify-content-md-end">
            <img class="img-fluid" src={promo} alt="Hero Promo"></img>
          </div>
        ...
        <div class="row g-5 py-2">
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_dashboard.html" target="_blank">
              <img class="img-fluid options-item" src={promo1} alt="Dashboard Default"></img>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_classic.html" target="_blank">
              <img class="img-fluid options-item" src={promo2} alt="Dashboard Classic"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_clean.html" target="_blank">
              <img class="img-fluid options-item" src={promo4} alt="Dashboard Clean"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_social.html" target="_blank">
              <img class="img-fluid options-item" src={promo3} alt="Dashboard Social"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_corporate.html" target="_blank">
              <img class="img-fluid options-item" src={promo5} alt="Dashboard Corporate"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_minimal.html" target="_blank">
              <img class="img-fluid options-item" src={promo6} alt="Dashboard Minimal"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_pop.html" target="_blank">
              <img class="img-fluid options-item" src={promo7} alt="Dashboard Pop"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="db_medical.html" target="_blank">
              <img class="img-fluid options-item" src={promo8} alt="Dashboard Medical"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_dashboard2.html" target="_blank">
              <img class="img-fluid options-item" src={promo9} alt="Dashboard Media"></img>
              <div class="options-overlay bg-black-50">
                <div class="options-overlay-content h5 fw-bold text-uppercase">
                  <i class="fa fa-link fa-2x"></i>
                </div>
          ...
          <div class="row g-5 py-2">
            <div class="col-md-4 py-2">
              <a class="options-container push text-white rounded overflow-hidden" href="be_pages_crypto_dashboard.html" target="_blank">
                <img class="img-fluid options-item" src={pack} alt="Page Pack Crypto"></img>
                <div class="options-overlay bg-black-50">
                  <div class="options-overlay-content h5 fw-bold text-uppercase">
                    <i class="fa fa-link fa-2x"></i>
                  </div>
            ...
            <div class="col-md-4 py-2">
              <a class="options-container push text-white rounded overflow-hidden" href="be_pages_ecom_dashboard.html" target="_blank">
                <img class="img-fluid options-item" src={pack1} alt="Page Pack e-Commerce"></img>
                <div class="options-overlay bg-black-50">
                  <div class="options-overlay-content h5 fw-bold text-uppercase">
                    <i class="fa fa-link fa-2x"></i>
                  </div>
            ...
            <div class="col-md-4 py-2">
              <a class="options-container push text-white rounded overflow-hidden" href="be_pages_elearning_courses.html" target="_blank">
                <img class="img-fluid options-item" src={pack2} alt="Page Pack e-Learning"></img>
                <div class="options-overlay bg-black-50">
                  <div class="options-overlay-content h5 fw-bold text-uppercase">
                    <i class="fa fa-link fa-2x"></i>
                  </div>
            ...
            <div class="col-md-4 py-2">
              <a class="options-container push text-white rounded overflow-hidden" href="be_pages_forum_categories.html" target="_blank">
                <img class="img-fluid options-item" src={pack3} alt="Page Pack Forum"></img>
                <div class="options-overlay bg-black-50">
                  <div class="options-overlay-content h5 fw-bold text-uppercase">
                    <i class="fa fa-link fa-2x"></i>
                  </div>
            ...
            <div class="col-md-4 py-2">
              <a class="options-container push text-white rounded overflow-hidden" href="be_pages_auth_all.html" target="_blank">
                <img class="img-fluid options-item" src={pack4} alt="Page Pack Authentication"></img>
                <div class="options-overlay bg-black-50">
                  <div class="options-overlay-content h5 fw-bold text-uppercase">
                    <i class="fa fa-link fa-2x"></i>
                  </div>
            ...
            <div class="col-md-4 py-3">
              <a class="options-container push text-white rounded overflow-hidden" href="be_pages_error_all.html" target="_blank">
                <img class="img-fluid options-item" src={pack5} alt="Page Pack Error"></img>
                <div class="options-overlay bg-black-50">
                  <div class="options-overlay-content h5 fw-bold text-uppercase">
                    <i class="fa fa-link fa-2x"></i>
                  </div>
      ...
      <div class="row g-0 pull-b text-center overflow-hidden">
        <div class="col-4">
          <a class="options-container" href="be_pages_dashboard.html" target="_blank">
            <img class="img-fluid options-item" src={pack6} alt="Backend Promo"></img>
        ...
        <div class="col-4">
          <a class="options-container" href="db_classic.html" target="_blank">
            <img class="img-fluid options-item" src={pack7} alt="Classic Dashboard Promo"></img>
            <div class="options-overlay bg-body-extra-light">
              <div class="options-overlay-content">
                <h3 class="h5 fw-bold text-uppercase mb-1">
        ...
        <div class="col-4">
          <a class="options-container" href="be_layout_api.html" target="_blank">
            <img class="img-fluid options-item" src={pack8} alt="Layout API Promo"></img>
            <div class="options-overlay bg-body-extra-light">
              <div class="options-overlay-content">
                <h3 class="h5 fw-bold text-uppercase mb-1">
      ...
      <div class="row g-0 pull-b text-center overflow-hidden">
        <div class="col-4">
          <a class="options-container" href="be_ui_grid.html" target="_blank">
            <img class="img-fluid options-item" src={land1} alt="Bootstrap 5 Grid Promo"></img>
        ...
        <div class="col-4">
          <a class="options-container" href="be_ui_typography.html" target="_blank">
            <img class="img-fluid options-item" src={land2} alt="Bootstrap 5 Typography Promo"></img>
            <div class="options-overlay bg-body-light">
              <div class="options-overlay-content">
                <h3 class="h5 fw-bold text-uppercase mb-1">
        ...
        <div class="col-4">
          <a class="options-container" href="be_ui_buttons.html" target="_blank">
            <img class="img-fluid options-item" src={land3} alt="Bootstrap 5 Buttons Promo"></img>
            <div class="options-overlay bg-body-light">
              <div class="options-overlay-content">
                <h3 class="h5 fw-bold text-uppercase mb-1">
  ...
  <div class="bg-body-extra-light">
    <div class="content content-full">
      ...
      <div class="row g-0 justify-content-center pull-b text-center overflow-hidden">
        <div class="col-sm-6">
          <img class="img-fluid" src={land4} alt="Smart Tools Promo"></img>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="bg-body-light">
    <div class="content content-full">
      ...
      <div class="row g-0 pull-b text-center overflow-hidden">
        <div class="col-4">
          <img class="img-fluid" src={land5} alt="Developer Minded PHP Promo"></img>
        </div>
        <div class="col-4">
          <img class="img-fluid" src={land6} alt="Developer Minded Docs Promo"></img>
        </div>
        <div class="col-4">
          <img class="img-fluid" src={land7} alt="Developer Minded HTML Promo"></img>
        </div>
      </div>
    </div>
  </div>
