...
import images from './media/photos/photo32@2x.jpg'
const Variation1image = () => {
  return (
    <div>
        ...
        <ul class="nav-main">
          ...
          <li class="nav-main-item open">
            ...
            <ul class="nav-main-submenu">
              ...
              <li class="nav-main-item">
                <a class="nav-main-link active" href="bd_variations_hero_image_1.html">
...
<main id="main-container">
  <div class="content content-full">
    <div class="block block-rounded bg-image" style={{
...
export default Variation1image