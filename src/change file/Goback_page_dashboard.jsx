...
import avatar from "./media/avatars/avatar15.jpg"
import avatar2 from "./media/avatars/avatar12.jpg"
import avatar3 from "./media/avatars/avatar4.jpg"
import avatar4 from "./media/avatars/avatar11.jpg"
import avatar5 from "./media/avatars/avatar3.jpg"
import turbo from "./media/favicons/turbo.png"
import turbo2 from "./media/favicons/turbo2.png"
const Goback_page_dashboard = () => {
  return (
    <div>
      ...
      <aside id="side-overlay">
        <div class="content-header">
          <a class="img-link me-2" href="be_pages_generic_profile.html">
            <img class="img-avatar img-avatar32" src={avatar} alt=""></img>
          </a>
              ...
              <ul class="nav-users">
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src={avatar5} alt=""></img>
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src={avatar4} alt=""></img>
                    <i class="fa fa-circle text-success"></i>
                    <div>Brian Cruz</div>
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src={avatar3} alt=""></img>
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src={avatar2} alt=""></img>
                    <div>Justin Hunt</div>
            ...
            <div class="content-side content-side-user px-0 py-0">
              ...
              <div class="smini-hidden text-center mx-auto">
                <a class="img-link" href="be_pages_generic_profile.html">
                  <img class="img-avatar" src={avatar} alt=""></img>
                </a>
...
export default Goback_page_dashboard