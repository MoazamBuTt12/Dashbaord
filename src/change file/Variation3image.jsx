...
import image3 from "./media/photos/photo13@2x.jpg"

import {Link} from "react-router-dom";

const Variation3image = () => {
  return (
    <div>
        ...
        <ul class="nav-main">
          ...
          <li class="nav-main-item open">
            ...
            <ul class="nav-main-submenu">
              ...
              <li class="nav-main-item">
                <a class="nav-main-link active" href="bd_variations_hero_image_3.html">
...
<main id="main-container">
  <div class="content content-full">
    <div class="block block-rounded block-transparent bg-image bg-image-bottom" style={{backgroundImage: `url(${image3})`,}}>
...
export default Variation3image