...
import videoFile from "./media/videos/city_night.jpg"

import {Link} from "react-router-dom";

const Variation1video = () => {
  return (
    <div>
        ...
        <ul class="nav-main">
          ...
          <li class="nav-main-item open">
            ...
            <ul class="nav-main-submenu">
              ...
              <li class="nav-main-item">
                <a class="nav-main-link active" href="bd_variations_hero_video_1.html">
...
<main id="main-container">
  <div class="content content-full">
    <div class="block block-rounded overflow-hidden block-transparent bg-video" >
...
export default Variation1video