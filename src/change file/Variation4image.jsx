...
import image4 from "./media/photos/photo20@2x.jpg"

import {Link} from "react-router-dom";

const Variation4image = () => {
  return (
    <div>
        ...
        <ul class="nav-main">
          ...
          <li class="nav-main-item open">
            ...
            <ul class="nav-main-submenu">
              ...
              <li class="nav-main-item">
                <a class="nav-main-link active" href="bd_variations_hero_image_4.html">
...
<main id="main-container">
  <div class="bg-image bg-image-bottom" style={{backgroundImage: `url(${image4})`,}}>
...
export default Variation4image